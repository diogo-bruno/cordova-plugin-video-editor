...
import org.apache.cordova.videoeditor.androidtranscoder.format.MediaFormatExtraConstants;
import org.apache.cordova.videoeditor.androidtranscoder.utils.AvcCsdUtils;
import org.apache.cordova.videoeditor.androidtranscoder.utils.AvcSpsUtils;
...
class MediaFormatValidator {
    ...
    public static void validateAudioOutputFormat(MediaFormat format) {
        String mime = format.getString(MediaFormat.KEY_MIME);
        if (!MediaFormatExtraConstants.MIMETYPE_AUDIO_AAC.equals(mime) && !MediaFormatExtraConstants.MIMETYPE_AUDIO_EAC3.equals(mime)) {
