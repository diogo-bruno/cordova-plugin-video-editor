 ...
 */
package org.apache.cordova.videoeditor.androidtranscoder.utils;
...
public class AvcCsdUtils {
    // Refer:
    // https://android.googlesource.com/platform/frameworks/av/+/lollipop-release/media/libstagefright/MediaCodec.cpp#2198
    ...
    public static ByteBuffer getSpsBuffer(MediaFormat format) {
        ByteBuffer sourceBuffer = format.getByteBuffer(MediaFormatExtraConstants.KEY_AVC_SPS).asReadOnlyBuffer(); // might
                                                                                                                  // be
                                                                                                                  // direct
                                                                                                                  // buffer
